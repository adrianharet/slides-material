...
\begin{document}\raggedright
    ...
    % There is a \emph{relatedness factor} \(r\), the probability that \(j\) and \(i\) share the same 
    % gene (i.e., strategy) by common descent. In this case \(i\) and \(j\) get paired for sure.
    % \vspace{1em}

    % But \(i\) and \(j\) can get paired up even if they're not related by common descent,
    % simply because the gene is common in the population: \(p\) cooperators, \(1-p\) defectors.
    % \vspace{1em}

    % This makes the pairing probabilities:
    % \begin{flalign*}
    %     \qquad
    %     {\Pr}{\big[ j = \text{C} \mid i = \text{C} \big]} & = r \cdot 1 + (1 - r) \cdot p, & \\
    %     {\Pr}{\big[ j = \text{D} \mid i = \text{C} \big]} & = r \cdot 0 + (1-r) \cdot (1-p), &\\
    %     {\Pr}{\big[ j = \text{D} \mid i = \text{D} \big]} & = r \cdot 1 + (1-r) \cdot (1-p), &\\
    %     {\Pr}{\big[ j = \text{C} \mid i = \text{D} \big]} & = r \cdot 0 + (1-r) \cdot p.&
    % \end{flalign*}
    % Plug this into the positive assortment equation to get:
    % \begin{flalign*}
    %     \qquad
    %     {\Pr}{\big[ j = \text{C} \mid i = \text{C} \big]} - {\Pr}{\big[ j = \text{C} \mid i = \text{D} \big]} & > \frac{c}{b} \qquad\text{iff}\\
    %     r \cdot 1 + (1 - r) \cdot p - \big(r \cdot 0 + (1-r) \cdot p \big) &> \frac{c}{b} \qquad\text{iff}&\\
    %     r &> \frac{c}{b}. &
    % \end{flalign*}
