...
\documentclass[preview, varwidth=12.5cm, border={0pt 5pt 0pt 1pt}]{standalone} % border options are {left bottom right top}
...
\begin{document}\raggedright
    ...
    % A \emph{mixed strategy} \(s_i\) for player \(i\) is a probability distribution over actions,
    % written \(s_i = \big(p_1, \dots , p_j, \dots \big)\), where \(p_i\) is the probability 
